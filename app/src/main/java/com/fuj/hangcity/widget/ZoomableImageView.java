...
import com.fuj.hangcity.listener.OnImageTouchedListener;
...
public class ZoomableImageView extends View {
	...
	// the bottom_user has done in terms of zooming and panning.
	//
	...
	protected void zoomIn(float rate) {
		if (getScale() >= mMaxZoom) {
			return;     // Don't let the bottom_user zoom into the molecular level.
		}
		if (mBitmap == null) {
			return;
		}
